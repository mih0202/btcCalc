! function (e) {
    ...
    return function e(t, n, r) {
                ...
                E(o, m), Object.defineProperty(o.prototype, "timeRemaining", {
                    ...
                    if (!t.metadata && !t.destroyed) {
                        ...
                        t._processParsedTorrent(n), t.metadata = t.torrentFile, t.client.enableWebSeeds && t.urlList.forEach(function (e) {
                            ...
                            if (t.files.map(function (e, r) {
                                ...
                                for (var r = 0; r < t.pieces.length; r++) t._markVerified(r);
                                t._onStore()
                    ...
                    function o(o) {
                        ...
                        for (var i = n(), a = 0; a < s._selections.length; a++) {
                            var c, f = s._selections[a];
                            if ("rarest" === s.strategy)
                                for (var d = f.from + f.offset, h = f.to, l = h - d + 1, p = {}, m = 0, g = t(d, h, p, i); m < l && !((c = s._rarityMap.getRarestPiece(g)) < 0);) {
                        ...
                        if (!e.downloaded) return function () {
                            if (!e.requests.length)
                                for (var n = s._selections.length; n--;) {
                                    var r, o = s._selections[n];
                                    if ("rarest" === s.strategy)
                                        for (var i = o.from + o.offset, a = o.to, u = a - i + 1, c = {}, f = 0, d = t(i, a, c); f < u && !((r = s._rarityMap.getRarestPiece(d)) < 0);) {
        ...
        8: [function (e, t, n) {
            ...
            function u(e) {
                for (var t, n = e.length, r = n % 3, o = "", i = [], s = 0, u = n - r; s < u; s += 16383) i.push(a(e, s, s + 16383 > u ? u : s + 16383));
        ...
        10: [function (e, t, n) {
            (function (e) {
                ...
                n.buffer = function (t, n) {
                    ...
                    e.push(o);
                    for (var i, s = 0, a = Object.keys(t).sort(), u = a.length; s < u; s++) i = a[s], null != t[i] && (n.buffer(e, i), n._encode(e, t[i]));
                    e.push(r)
                }, n.list = function (e, t) {
                    var o = 0,
                        s = t.length;
        ...
        12: [function (e, t, n) {
            t.exports = function (e, t, n, r, o) {
                ...
                for (; r <= o;)
                    if (i = r + (o - r >> 1), (s = +n(e[i], t, i, e)) < 0) r = i + 1;
                    else {
                        if (!(s > 0)) return i;
                        o = i - 1
                    }
        ...
        17: [function (e, t, n) {
            ...
            a(r, h), r.prototype.DEFAULT_ANNOUNCE_INTERVAL = 3e4, r.prototype.announce = function (e) {
                ...
                e.reconnecting = !0, clearTimeout(e.reconnectTimer), e.reconnectTimer = setTimeout(function () {
                    ...
                    e.reconnectTimer.unref && e.reconnectTimer.unref(), i("reconnecting socket in %s ms", t)
        ...
        20: [function (e, t, n) {
            (function (n) {
                function r(e, t) {
                    ...
                    i.call(this), t || (t = {}), "object" == typeof e && (t = e, e = t.size), this.size = e || 512, t.nopad ? this._zeroPadding = !1 : this._zeroPadding = s(t.zeroPadding, !0), this._buffered = [], this._bufferedBytes = 0
                }
                var o = e("inherits"),
        ...
        33: [function (e, t, n) {
            var r = e("once"),
                ...
                a = function (e, t, n) {
                    ...
                    return i(e) ? (e.on("complete", l), e.on("abort", g), e.req ? y() : e.on("request", y)) : d && !u && (e.on("end", h), e.on("close", h)), s(e) && e.on("exit", m), e.on("end", p), e.on("finish", l), !1 !== t.error && e.on("error", n), e.on("close", g),
                        function () {
                ...
                function r(e) {
                    ...
                    if (t.xt) {
                        (Array.isArray(t.xt) ? t.xt : [t.xt]).forEach(function (e) {
                            if (o = e.match(/^urn:btih:(.{40})/)) t.infoHash = o[1].toLowerCase();
        ...
        51: [function (e, t, n) {
            (function (t) {
                ...
                n.fullBoxes = {}, ["mvhd", "tkhd", "mdhd", "vmhd", "smhd", "stsd", "esds", "stsz", "stco", "stss", "stts", "ctts", "stsc", "dref", "elst", "hdlr", "mehd", "trex", "mfhd", "tfhd", "tfdt", "trun"].forEach(function (e) {
                    ...
                    e = e.slice(t);
                    for (var n = e.readUInt32BE(0), r = e.readUInt32BE(4), o = new Array(r), i = 0; i < r; i++) o[i] = 0 === n ? e.readUInt32BE(4 * i + 8) : n;
                    return {
                        entries: o
                    }
        ...
        64: [function (e, t, n) {
            for (var r = e("closest-to"), o = Math.pow(2, 10), i = 13, s = []; i++ < 22;) s.push(Math.pow(2, i));
            t.exports = function (e) {
                return r(e / o, s)
            }
        }, {
        ...
        68: [function (t, n, r) {
            (function (t) {
                ! function (o) {
                    ...
                    function h(e, t, n) {
                        var r = 0;
                        for (e = n ? P(e / B) : e >> 1, e += P(e / t); e > M * S >> 1; r += k) e = P(e / M);
                    ...
                    function l(e) {
                        var t, n, r, o, s, a, u, d, l, p, m = [],
                            ...
                            _ = C,
                            v = A;
                        for (n = e.lastIndexOf(T), n < 0 && (n = 0), r = 0; r < n; ++r) e.charCodeAt(r) >= 128 && i("not-basic"), m.push(e.charCodeAt(r));
                        for (o = n > 0 ? n + 1 : 0; o < g;) {
                            for (s = y, a = 1, u = k; o >= g && i("invalid-input"), d = f(e.charCodeAt(o++)), (d >= k || d > P((E - y) / a)) && i("overflow"), y += d * a, l = u <= v ? x : u >= v + S ? S : u - v, !(d < l); u += k) p = k - l, a > P(E / p) && i("overflow"), a *= p;
                    ...
                    function p(e) {
                        ...
                        for (e = u(e), g = e.length, t = C, n = 0, s = A, a = 0; a < g; ++a)(m = e[a]) < 128 && b.push(j(m));
                        for (r = o = b.length, o && b.push(T); r < g;) {
                            for (c = E, a = 0; a < g; ++a)(m = e[a]) >= t && m < c && (c = m);
                            for (y = r + 1, c - t > P((E - n) / y) && i("overflow"), n += (c - t) * y, t = c, a = 0; a < g; ++a)
                                if (m = e[a], m < t && ++n > E && i("overflow"), m == t) {
                                    for (f = n, l = k; p = l <= s ? x : l >= s + S ? S : l - s, !(f < p); l += k) v = f - p, _ = k - p, b.push(j(d(p + v % _, 0))), f = P(v / _);
        ...
        69: [function (e, t, n) {
            ...
            t.exports = function (e, t, n, i) {
                ...
                a > 0 && u > a && (u = a);
                for (var c = 0; c < u; ++c) {
                    var f, d, h, l, p = e[c].replace(/\+/g, "%20"),
                        m = p.indexOf(n);
        ...
        77: [function (e, t, n) {
            (function (n) {
                ...
                t.exports = i;
                var A, C = e("process-nextick-args"),
                    T = e("isarray");
                i.ReadableState = o;
                ...
                var H, N = e("./internal/streams/BufferList");
                M.inherits(i, U);
                ...
                i.prototype.read = function (e) {
                    ...
                    for (var i = 0; i < q.length; i++) e.on(q[i], r.emit.bind(r, q[i]));
        ...
        83: [function (e, t, n) {
            ...
            function i(e, t, n, r) {
                ...
                var p, _ = l.extname(e.name).toLowerCase(),
                    k = 0;
                ...
                ! function () {
                    function n(e) {
                        ...
                        for (var t = {
                            ...
                            if (!(r < u + a)) {
                                for (i = 4 - a; i < c; i = i + 4 | 0) t[o + i >> 2] = s.charCodeAt(n + i) << 24 | s.charCodeAt(n + i + 1) << 16 | s.charCodeAt(n + i + 2) << 8 | s.charCodeAt(n + i + 3);
                                switch (u) {
                                    case 3:
                            ...
                            if (!(r < u + a)) {
                                for (i = 4 - a; i < c; i = i + 4 | 0) t[o + i >> 2 | 0] = s[n + i] << 24 | s[n + i + 1] << 16 | s[n + i + 2] << 8 | s[n + i + 3];
                                switch (u) {
                                    case 3:
                                        e[o + c + 1 | 0] = s[n + c + 2];
                                    case 2:
                            ...
                            if (!(r < c + u)) {
                                for (s = 4 - u; s < f; s = s + 4 | 0) t[i + s >> 2 | 0] = d[s] << 24 | d[s + 1] << 16 | d[s + 2] << 8 | d[s + 3];
                                switch (c) {
                                    case 3:
                                        e[i + f + 1 | 0] = d[f + 2];
                                    case 2:
                        ...
                        this.digest = this.digestFromString = this.digestFromBuffer = this.digestFromArrayBuffer = function (e) {
                            ...
                            for (t.offset += o; r < o;) n = Math.min(o - r, t.maxChunkLen - i), _(e, r, n, i), i += n, r += n, i === t.maxChunkLen && (t.core.hash(t.maxChunkLen, t.padMaxChunkLen), i = 0);
                            return this
            ...
            (function (n) {
                function r(e) {
                    ...
                    if (t._id = a(4).toString("hex").slice(0, 7), t._debug("new websocket: %o", e), e = Object.assign({
                        allowHalfOpen: !1
                    }, e), u.Duplex.call(t, e), t.connected = !1, t.destroyed = !1, t._chunk = null, t._cb = null, t._interval = null, e.socket) t.url = e.socket.url, t._ws = e.socket;
                    else {
                        t.url = e.url;
                        try {
        ...
        94: [function (e, t, n) {
            ...
            i.unref && i.unref(), t.exports = function (e) {
                ...
                return function (e) {
                    var s = r - i & 65535;
                    for (s > t && (s = t), i = r; s--;) o === t && (o = 0), n[o] = n[0 === o ? t - 1 : o - 1], o++;
                    e && (n[o - 1] += e);
                    var a = n[o - 1],
            ...
            (function (n, r, o) {
                ...
                var a = e("./capability"),
                    ...
                    p = t.exports = function (e) {
                        ...
                        var n, r = !0;
                        if ("disable-fetch" === e.mode || "timeout" in e) r = !1, n = !0;
        ...
        112: [function (e, t, n) {
            ...
            r.prototype.parse = function (e, t, n) {
                ...
                if (!v[d] && (p || d && !b[d])) {
                    ...
                    if (!B)
                        for (var A = this.hostname.split(/\./), k = 0, C = A.length; k < C; k++) {
                            var T = A[k];
                            if (T && !T.match(/^[+a-z0-9A-Z_-]{0,63}$/)) {
                                for (var L = "", U = 0, R = T.length; U < R; U++) T.charCodeAt(U) > 127 ? L += "x" : L += T[U];
                ...
                if (x && (n.hostname = "", n.port = null, n.host && ("" === k[0] ? k[0] = n.host : k.unshift(n.host)), n.host = "", e.protocol && (e.hostname = null, e.port = null, e.host && ("" === p[0] ? p[0] = e.host : p.unshift(e.host)), e.host = null), w = w && ("" === p[0] || "" === k[0])), _) n.host = e.host || "" === e.host ? e.host : n.host, n.hostname = e.hostname || "" === e.hostname ? e.hostname : n.hostname, n.search = e.search, n.query = e.query, k = p;
                ...
                for (var I = k.slice(-1)[0], B = (n.host || e.host || k.length > 1) && ("." === I || ".." === I) || "" === I, A = 0, C = k.length; C >= 0; C--) I = k[C], "." === I ? k.splice(C, 1) : ".." === I ? (k.splice(C, 1), A++) : A && (k.splice(C, 1), A--);
                if (!w && !E)
                    for (; A--; A) k.unshift("..");
